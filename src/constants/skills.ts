...
export const SKILL_TREE_DATA: Record<string, SkillNode> = {
    ...
    'fire_notable_1':     N('fire_notable_1', '1차 해금: STR 계수', '화염 피해에 힘(STR) 계수가 적용됩니다.', 'NOTABLE', 5, ['fire_str_3'], {}),
    ...
    'fire_notable_dmg':   N('fire_notable_dmg', '2차 해금: 피해 증폭', '화염 피해의 기본 피해량과 STR 계수가 증폭됩니다.', 'NOTABLE', 8, ['fire_dmg_3'], {}),
    ...
    'fire_notable_pen':   N('fire_notable_pen', '3차 해금: 화상', '화염 피해가 적에게 지속 피해를 입히는 화상 효과를 부여합니다.', 'NOTABLE', 8, ['fire_pen_3'], {}),
    ...
    'water_notable_1':    N('water_notable_1', '1차 해금: 쉴드 회복', '공격 시마다 최대 체력에 비례한 쉴드를 회복합니다.', 'NOTABLE', 5, ['water_con_3'], {}),
    ...
    'water_notable_ref':  N('water_notable_ref', '3차 해금: 피해 반사', '피격 시 받은 피해의 일부를 적에게 되돌려줍니다.', 'NOTABLE', 8, ['water_ref_3'], {}),
    ...
    'water_notable_hp':   N('water_notable_hp', '2차 해금: 쉴드 증폭', '전투 시작 시 얻는 쉴드의 양이 대폭 증가합니다.', 'NOTABLE', 8, ['water_hp_3'], {}),
    ...
    'wind_notable_1':     N('wind_notable_1', '1차 해금: 연격', 'N회 공격마다 추가 공격(연격)이 발동합니다.', 'NOTABLE', 5, ['wind_dex_3'], {}),
    ...
    'wind_notable_combo': N('wind_notable_combo', '2차 해금: 연격 강화', '연격 발동에 필요한 공격 횟수가 감소하고, 연격의 데미지가 증가합니다.', 'NOTABLE', 8, ['wind_combo_3'], {}),
    ...
    'wind_notable_eva':   N('wind_notable_eva', '3차 해금: 확정 회피', 'N회 공격마다 다음 피격을 100% 회피하는 \'잔상\' 효과를 얻습니다.', 'NOTABLE', 8, ['wind_eva_3'], {}),
    ...
    'elec_notable_1':     N('elec_notable_1', '1차 해금: 기절', 'N회 공격마다 적을 짧은 시간 동안 기절시킵니다.', 'NOTABLE', 5, ['elec_util_3'], {}),
    ...
    'elec_notable_stun':  N('elec_notable_stun', '2차 해금: 기절 강화', '기절 발동에 필요한 공격 횟수가 감소하고, 기절 지속 시간이 증가합니다.', 'NOTABLE', 8, ['elec_stun_3'], {}),
    ...
    'elec_notable_exec':  N('elec_notable_exec', '3차 해금: 처형', '기절 상태인 적에게 공격 시 강력한 추가 피해를 입힙니다.', 'NOTABLE', 8, ['elec_exec_3'], {}),
